            ...
            {{-- <div class="row">
              <div class="col-md-6">
                <select name="installment_type" class="form-control" required>
                  ...
                  <option value="1" @if($savingname->installment_type == 1) selected="" @endif>Weekly</option>
                  <option value="2" @if($savingname->installment_type == 2) selected="" @endif>Fortnightly</option>
                  <option value="3" @if($savingname->installment_type == 3) selected="" @endif>Monthly</option>
                </select>
              </div>
            </div> --}}
            {{-- <div class="row">
