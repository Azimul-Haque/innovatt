...
@section('title', 'Add Scheme Name | Microfinance Management')
  ...
  <div class="row">
      <div class="col-md-6">
        <div class="panel panel-primary">
          <div class="panel-heading">Add Scheme Name</div>
          {!! Form::open(['route' => 'dashboard.schemenames.store', 'method' => 'POST']) !!}
